...
if(projectile_cooldown <= 0)
{
	...
	_inst = instance_create_layer(x, y, instance_layer, obj_projectile_heart);
	_inst.image_angle = _angle + 150;
	_inst.fire_angle = _angle + 150;
	
	_inst = instance_create_layer(x, y, instance_layer, obj_projectile_heart);
	_inst.image_angle = _angle + 210;
	_inst.fire_angle = _angle + 210;
