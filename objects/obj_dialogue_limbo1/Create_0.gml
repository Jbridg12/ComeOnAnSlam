...
dialog.add(dialogue_nadia, "Who are you again?");
dialog.add(dialogue_joan, "Oh NADIA, you wound me! ");
dialog.add(dialogue_joan, "Its work mother Joan, you know you’d have been fired eons ago if I hadn't showed you the ropes.");
